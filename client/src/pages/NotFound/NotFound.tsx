...
export default function NotFound() {
  return (
    <main
      className={`min-h-screen w-full bg-white flex flex-col justify-center items-center`}
    >
      <div className="flex flex-col items-center space-y-6 px-4">
        {/* Animated SVG */}
        <div className="animate-swing">
          <svg viewBox="0 0 541.17206 328.45184" height="280" width="460" className="max-w-full h-auto">
            <defs>
              <pattern
            ...
            {/* Hanging rope and pendulum */}
            <g transform="translate(170.14515,0.038164)">
              <g id="g6219" className="origin-[85px_4px] animate-swing">
                {/* Rope */}
                <path
                ...
                <g>
                  ...
                  <path
                    ...
                    style={{ fill: "#000000", stroke: "#000000", strokeWidth: "1px" }}
                  />
                  ...
                  <rect
                    ...
                    height="9.8994951"
                    width="100.76272"
                    style={{ fill: "#000000", stroke: "#000000", strokeWidth: "1.00157475" }}
                  />

                  {/* Various rope strands */}
                  <path
                  ...
                  <path
                    ...
                    style={{ fill: "none", stroke: "#000000", strokeWidth: "1.00614154px" }}
                  />
                  ...
                  <ellipse
                    ...
                    cy="4.3948641"
                    cx="85.016434"
                    style={{ fill: "#000000", stroke: "#000000", strokeWidth: "0.82170224" }}
                  />
                </g>
              </g>
            </g>
        ...
        {/* Error text */}
        <p className="text-2xl font-normal text-black" id="errorText">
          O-o-oh! Page Not Found.
        </p>

        {/* Action button */}
        <Link
          to="/home"
          className="text-xl px-6 py-3 border border-black text-black bg-transparent no-underline transition-all duration-500 ease-in-out hover:text-white hover:bg-black focus:text-white focus:bg-black"
          id="errorLink"
        >
          Go Home
        </Link>
